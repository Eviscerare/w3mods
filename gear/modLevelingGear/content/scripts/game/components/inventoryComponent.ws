...
import class CInventoryComponent extends CComponent
{
    ...
    public function isItemScalable(item : SItemUniqueId) : bool
    {
    	var itemName, itemCategory : name;
    	var itemQuality : int;
    	...
    	if ( itemCategory != 'armor' && itemCategory != 'gloves' && itemCategory != 'boots' && itemCategory != 'pants'
    		&& !ItemHasTag(item, 'PlayerSteelWeapon') && !ItemHasTag(item, 'PlayerSilverWeapon') || ItemHasTag(item, 'Aerondight') )
    		return false;
    	
    	return	itemQuality == 5 || ( itemQuality == 4 && ItemHasTag(item, 'EP1') )
				|| itemName == 'DLC1 Temerian Armor'
				|| itemName == 'DLC1 Temerian Boots'
				|| itemName == 'DLC1 Temerian Gloves'
				|| itemName == 'DLC1 Temerian Pants'
				|| itemName == 'DLC5 Nilfgaardian Armor'
				|| itemName == 'DLC5 Nilfgaardian Boots'
				|| itemName == 'DLC5 Nilfgaardian Gloves'
				|| itemName == 'DLC5 Nilfgaardian Pants'
				|| itemName == 'DLC14 Skellige Armor'
				|| itemName == 'DLC14 Skellige Boots'
				|| itemName == 'DLC14 Skellige Gloves'
				|| itemName == 'DLC14 Skellige Pants'
				|| itemName == 'NGP DLC1 Temerian Armor'
				|| itemName == 'NGP DLC1 Temerian Boots'
				|| itemName == 'NGP DLC1 Temerian Gloves'
				|| itemName == 'NGP DLC1 Temerian Pants'
				|| itemName == 'NGP DLC5 Nilfgaardian Armor'
				|| itemName == 'NGP DLC5 Nilfgaardian Boots'
				|| itemName == 'NGP DLC5 Nilfgaardian Gloves'
				|| itemName == 'NGP DLC5 Nilfgaardian Pants'
				|| itemName == 'NGP DLC14 Skellige Armor'
				|| itemName == 'NGP DLC14 Skellige Boots'
				|| itemName == 'NGP DLC14 Skellige Gloves'
				|| itemName == 'NGP DLC14 Skellige Pants';
    }
    ...
    public final function GetItemArmorTotal(item : SItemUniqueId, optional levelsToScale : int) : SAbilityAttributeValue
    {
    ...
    public final function GetItemLevel(item : SItemUniqueId, optional scaled : bool) : int
    {
		...
		level = theGame.params.GetItemLevel(itemCategory, itemAttributes, itemName, true); // modScalingArmor
		...
		// ***** modScalingArmors
		maxLevel = GetWitcherPlayer().GetMaxLevel();
		levelTarget = GetWitcherPlayer().GetLevel();

		if ( level < 1 ) level = 1;	if ( level > maxLevel ) level = maxLevel;
		
		if ( !scaled && isItemScalable(item) && levelTarget > level ) {
			GetItemArmorTotal(item, levelTarget - level);
			return GetItemLevel(item, true);
		}
		// ***** modScalingArmors
	...
	event OnItemAdded(data : SItemChangedData)
	{
		...
		// ***** modScalingArmors
		if( isItemScalable(itemId) )
			thePlayer.GetInventory().GetItemLevel(itemId); // Makes sure the item level is set when you start playing
		// ***** modScalingArmors
